...
class ClientHandler(threading.Thread):
    def __init__(self, client_socket, address, active_connections,voting_list, client_service, voted_clients):
...
def main():
    ...
    while True:
        ...
        client_handler = ClientHandler(client_socket, addr, global_active_connections, global_voting_list, global_client_service, global_voted_clients)
